...
How to run:
    ...
    lb-run DaVinci/v45r8 python plot_double_gaussian.py                  # operates on 'DVntuple_jpsi_all.root'
    lb-run DaVinci/v45r8 python plot_double_gaussian.py <ntuple_name>    # operates on specified ntuple
...
c.SaveAs('Bplus_double_gaussian_magup.png')
show('Bplus_double_gaussian_magup.png') # Remove this line if you don't want to deal with serve_plots.py and show.py files. The script then only saves the image to the working directory
